// 25.13 does not include the commented out sections below

// comp that receives the handle fnc to increase/decrease parameters upon clicking the +/- icons.
...
// 25.17: asynchronous fnc using superagent library - makes server req to update data
function update(section, value) {
 ...
 // 25.17: asynchronous fnc using superagent library - makes server req to read data
function read() {
    return new Promise((resolve, reject) => {
        var url = '/data';
        superagent
